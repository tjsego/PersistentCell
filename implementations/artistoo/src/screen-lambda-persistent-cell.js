...
function logStats(){
	...
	console.log(  this.time + "," + lambda_value+ "-"+ seed + "," + centroid.join(",") + "," + area + "," + perim + "," + lambda_value )		
}
...
// print header
console.log( "time,id,com_1,com_2,area,surface,lambda_dir" )	

for( let l of configJSON['model_args']['lambda_dir_values']){
	run(l)
}
